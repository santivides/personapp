...
public class TelefonoMenu {
    ...
    private static final int OPCION_VER_TODOS_TELEFONOS = 1;
            ...
            try {
                ...
                switch (opcion) {
                    case OPCION_REGRESAR_MOTOR_PERSISTENCIA:
                        isValid = true;
                        break;
                    case OPCION_VER_TODOS_TELEFONOS:
                ...
                keyboard.next(); // Limpiar el buffer de entrada
            }
        } while (!isValid);
    }
    ...
    private void mostrarMenuOpciones() {
        System.out.println("----------------------");
        System.out.println(OPCION_VER_TODOS_TELEFONOS + " para ver todos los teléfonos");
